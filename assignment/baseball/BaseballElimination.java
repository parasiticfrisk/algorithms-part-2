...
/**
 * Baseball elimination problem: there is a division consisting of n teams.
 * At some point during the season, team i has w[i] wins, l[i] losses, r[i]
 * remaining games, and g[i][j] games left to play against team j. A team is
 * mathematically eliminated if it cannot possibly finish the season in
 * (or tied for) first place.
 * The goal is to determine exactly which teams are mathematically eliminated.
 * Assume that no games end in a tie and that there are no rainouts
