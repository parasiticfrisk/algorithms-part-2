...
/**
 * Boggle solver that finds all valid words in a given Boggle board,
...
public class BoggleSolver {
    ...
    private void boardDFS(StringBuilder word, Node node, int i, int j, boolean[][] marked, Queue<String> queue,
            BoggleBoard board) {
        if (!marked[i][j]) {
            marked[i][j] = true;
