...
/**
 * Given a text file in which sequences of the same character occur near each
 * other many times, convert it into a text file in which certain characters
 * appear much more frequently that others.
 */
